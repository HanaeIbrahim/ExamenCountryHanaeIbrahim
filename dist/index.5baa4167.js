...
const getCountry = ()=>{
    ...
    countries.then((data)=>{
        ...
        results.forEach((element)=>{
            tableauCountry.push(new (0, _countryJsDefault.default)(element.name.countries, element.flags[0]));
        });
        console.log(tableauCountry);
        const game = new (0, _gameJsDefault.default)(countries);
...
},{"./country.js":"ePDPD","./Game.js":"dSAJu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ePDPD":[function(require,module,exports) {
/*class Country {
...
},{"./country.js":"ePDPD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hbj89","igcvL"], "igcvL", "parcelRequire2b81")
